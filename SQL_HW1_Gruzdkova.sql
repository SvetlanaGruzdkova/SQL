...
select * from students where name like '%a%'or name like '%а%' or name like '%А%' or name like '%A%';
--13. Вывести пользователей которые были созданы 2021-07-12 00:00:00
select * from students where created_on = '2021-07-12 00:00:00';
--14. Вывести пользователей которые были созданы 2021-07-12 00:00:00 и имеют пароль 1m313
select * from students where created_on in ('2021-07-12 00:00:00') and password in ('1m313');
...
--Вывести у которых id меньше 27 или больше 88
